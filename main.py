...
app = FastAPI(title="Space Tourism Agency", version="1.0.0",)
...
def read_tours(max_price_mln: float | None = Query(default=None, gt=0), max_duration_days: int | None = Query(default=None, ge=1), difficulty: Difficulty | None = Query(default=None), search: str | None = Query(default=None, min_length=1, max_length=80)) -> TourListResponse:
